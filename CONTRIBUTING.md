...
**P3 / ADR-0020:** inbound-persistence PRs must **not** modify [ADR-0020](docs/adr/ADR-0020-tenant-whatsapp-connection-lifecycle.md) or the v1 lifecycle module. Needs that break Compatibility Promise go to `lifecycle_version = 2`.
